        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LivingAddressId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patients", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_Patients_Addresses_LivingAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkingAddressId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Doctors_Addresses_WorkingAddressId",
                        column: x => x.WorkingAddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "Id", "City", "Country", "Region", "Street" },
                values: new object[,]
                {
                    { 1, "Rive", "Ukraine", "Rivne", "Pushkina/11" },
                    { 2, "Rive", "Ukraine", "Rivne", "Pushkina/22" },
                    { 3, "Rive", "Ukraine", "Rivne", "Pushkina/33" }
                });

            migrationBuilder.InsertData(
                table: "Specializations",
                columns: new[] { "Id", "Description", "Name" },
                values: new object[] { 1, "Default doctors specialization", "Terapevt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Doctors_WorkingAddressId",
                table: "Doctors",
                column: "WorkingAddressId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Patients_LivingAddressId",
                table: "Patients",
